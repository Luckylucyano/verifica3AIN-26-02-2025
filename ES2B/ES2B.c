/*Es. 2 – Scrivere un programma che inseriti casualmente in un array di N elementi dei numeri(valori
	da 10 a 100), i, dopo averli ordinati in modo decrescente, calcoli il prodotto dei numeri contenuti
	nell’array*/
...
int main() {//funzione principale
	...
	for (i = 0; i < N; i++) {//ciclo for per inserire i numeri nell'array
		vett[i] = rand() % 91 + 10;//inserisco i numeri casuali nell'array da 10 a 100
	}
