/*Es. 5- Scrivi un programma che, memorizzi in un array tanti numeri casuali compresi tra -100 e 100,
quanti ne vuole l’utente, stando attento a non sforare la dimensione massima dell’array, calcola e
stampa la media utilizzando una sola variabile media (non è concesso l’uso della variabile somma)*/
...
int main() {//funzione principale
	...
	for (i = 0; i < n; i++) {	//ciclo for per inserire i numeri casuali nell'array
		vett[i] = rand() % 201 - 100;//inserisco i numeri casuali nell'array
