/*Es. 1 – Scrivere un programma che cerca con l’algoritmo corretto un numero all’interno di un vettore
di N elementi inseriti da tastiera, lo riordina, stampa a video, quante volte compare e in che
posizioni*/
