/*Es. 3 – Dato un array di numeri interi, immessi da tastiera, si calcoli e si stampi la componente più
grande e la componente più piccola e le relative posizioni all’interno dell’array*/
