/*Es. 3 - Scrivere un programma che permetta di ruotare un array di numeri interi 
verso destra di un numero n di posizioni(n va normalizzata) 
usa una variabile di appoggio e non un vettore*/
